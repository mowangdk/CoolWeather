...
/**
 * Created by geyingqi on 10/10/15.
 */
public class ChooseAreaActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //已经选择了城市且不是从WeatherActivity跳转过来才会直接跳到weatherActivity中
    ...
    /*
    * 这里由于牵涉到了ui操作,因此必须要在主线程中操作
    * 这里借用了runOnUiThread方法来实现从子线程切换到主线程
    * 实现原理也是基于异步消息处理机制的.现在数据库中已经存在了数据
    ...
    * */
    ...
    //这里重写这个方法是用来覆盖默认的back键的行为.这里会根据当前的级别判断
    //返回市级列表还是省级列表还是直接退出
    @Override
